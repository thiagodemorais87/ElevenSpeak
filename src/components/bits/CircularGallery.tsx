...
const DEFAULT_FONT = '600 14px "Space Grotesk", sans-serif'
...
async function resolveFont(font: string, fontUrl?: string): Promise<string> {
 // When no fontUrl is supplied, ensure the canvas font family is ready.
...
export function CircularGallery({
 ...
 if (app) app.destroy();
  ...
  return (
    <div
      ref={containerRef}
      className="circular-gallery h-full w-full outline-none"
      tabIndex={0}
      role="region"
